...
author:
  name: liyunzhi
  link: https://github.com/liyz243
---

## 📚Blog
这是一个兼具博客文章、知识管理、文档查找的个人网站，主要内容是java后端技术。如果你喜欢这个博客&主题欢迎到[GitHub](https://github.com/liyz243/blog)点个Star。 ( •̀ ω •́ )✧
...
### 技能
* 熟悉 java、springboot、springmvc、spring 的拼写
