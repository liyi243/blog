...
const DOMAIN_NAME = 'liyi243.cn' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'https://github.com/liyi243/liyi243.github.io', // 导航栏右侧生成Github链接
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: '后端博客,个人技术博客,后端,后端开发,后端框架,web后端,java后端面试题,技术文档,学习,面试',
      },
    ],
