...
- name: 徐华杰（Bert）的博客
  desc: 正在努力！
  avatar: http://smarthua.cn/logo.png
  link: http://smarthua.cn/
  bgColor: '#FFEFE2'
  textColor: '#A05F2C'
- name: IT咖
  desc: 'java掘金用户'
  avatar: https://p6-passport.byteacctimg.com/img/user-avatar/782d05e48a6f95befa9791a09d5b1614~300x300.image
  link: https://juejin.cn/user/3822333357210557
  bgColor: '#B9D59C'
  textColor: '#3B551F'
- name: 程云来的博客
  desc: 全栈开发技术博客，<br/>
  avatar: https://chengyunlai.top/Chengyunlai.png
  link: https://chengyunlai.top/
  bgColor: '#FBEBEC'
  textColor: '#603420'
- name: IT咖
  desc: CSDN用户
  avatar: https://pic3.zhimg.com/80/v2-3de7e35966a157de975331e34a1c5fb6_1440w.jpg #可选
  link: https://blog.csdn.net/qq_41861216?spm=1000.2115.3001.5343 # 可选
  bgColor: '#CBEAFA' # 可选，默认var(--bodyBg)。颜色值有#号时请添加单引号
  textColor: '#6854A1' # 可选，默认var(--textColor)
- name: Chengyunlai
  desc: java前后端、运维部署资源技术分享
  avatar: https://p9-passport.byteacctimg.com/img/user-avatar/72888e973cf089904491daab881e050b~300x300.image
  link: https://juejin.cn/user/391873608037390
  bgColor: '#FCE5BF'
  textColor: '#7B2532'
- name: 闲坐含香咀翠
  desc: 区块链、node前后端、运维资源技术分析
  avatar: https://p26-passport.byteacctimg.com/img/user-avatar/5ce8f3eae9abe78669209d094089810e~300x300.image
  link: https://juejin.cn/user/3844369926334215
  bgColor: '#FFE5B4'
  textColor: '#A05F2C'
- name: lizy243
  desc: Github
  avatar: https://avatars.githubusercontent.com/u/98333006?v=4
...
- name: Evan's blog # 昵称
  ...
  avatar: https://p6-passport.byteacctimg.com/img/user-avatar/782d05e48a6f95befa9791a09d5b1614~300x300.image # 头像
  link: https://juejin.cn/user/3822333357210557 # 链接
```
